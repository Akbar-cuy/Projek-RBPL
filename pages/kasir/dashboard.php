    ...
    <div class="admin-layout">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <nav style="flex:1;padding:10px 0">
                <a href="dashboard.php" class="nav-link active"><svg width="18" height="18" fill="none"
                        stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" />
                        <polyline points="9 22 9 12 15 12 15 22" />
                    </svg>Dashboard</a>
                <a href="orders.php" class="nav-link"><svg width="18" height="18" fill="none" stroke="currentColor"
                        stroke-width="2" viewBox="0 0 24 24">
                        <circle cx="9" cy="21" r="1" />
                        <circle cx="20" cy="21" r="1" />
                        <path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6" />
                    </svg>Pesanan<?php if ($pendingCount > 0): ?><span
                            class="nav-badge"><?= $pendingCount ?></span><?php endif; ?></a>
                <a href="bookings.php" class="nav-link"><svg width="18" height="18" fill="none" stroke="currentColor"
                        stroke-width="2" viewBox="0 0 24 24">
                ...
                <a href="menu.php" class="nav-link"><svg width="18" height="18" fill="none" stroke="currentColor"
                        stroke-width="2" viewBox="0 0 24 24">
                        <path d="M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4zM3 6h18M16 10a4 4 0 0 1-8 0" />
                    </svg>Kelola Menu</a>
                <a href="reports.php" class="nav-link"><svg width="18" height="18" fill="none" stroke="currentColor"
                        stroke-width="2" viewBox="0 0 24 24">
                        <line x1="18" y1="20" x2="18" y2="10" />
                        <line x1="12" y1="20" x2="12" y2="4" />
                        <line x1="6" y1="20" x2="6" y2="14" />
                    </svg>Laporan</a>
                <a href="settings.php" class="nav-link"><svg width="18" height="18" fill="none" stroke="currentColor"
                        stroke-width="2" viewBox="0 0 24 24">
            ...
            <a href="../../logout.php" class="sb-logout"><svg width="16" height="16" fill="none" stroke="currentColor"
                    stroke-width="2" viewBox="0 0 24 24">
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <h1 style="font-size:1.4rem;font-weight:800;margin-bottom:4px">Selamat Datang,
                    <?= htmlspecialchars(explode(' ', $_SESSION['name'])[0]) ?>! 👋</h1>
                <p style="color:var(--text-muted);font-size:0.875rem;margin-bottom:24px">Ringkasan aktivitas hari ini.
                </p>

                <div class="stats-grid">
                    <div class="stat-card">
                        <div class="stat-icon" style="background:rgba(34,197,94,0.15)"><svg width="22" height="22"
                                fill="none" stroke="#22c55e" stroke-width="2" viewBox="0 0 24 24">
                    ...
                    <div class="stat-card">
                        <div class="stat-icon" style="background:rgba(59,130,246,0.15)"><svg width="22" height="22"
                                fill="none" stroke="#3b82f6" stroke-width="2" viewBox="0 0 24 24">
                    ...
                    <div class="stat-card">
                        <div class="stat-icon" style="background:rgba(168,85,247,0.15)"><svg width="22" height="22"
                                fill="none" stroke="#a855f7" stroke-width="2" viewBox="0 0 24 24">
                    ...
                    <div class="stat-card">
                        <div class="stat-icon" style="background:rgba(245,158,11,0.15)"><svg width="22" height="22"
                        ...
                        <table>
                            <tbody>
                                <?php if (empty($recentOrders)): ?>
                                    <tr>
                                        <td style="text-align:center;color:var(--text-muted);padding:24px">Belum ada pesanan
                                        </td>
                                    </tr>
                                <?php else:
                                        ...
                                        <tr>
                                            <td>
                                                <div style="font-weight:600;font-size:0.83rem">
                                                    <?= htmlspecialchars($o['cname']) ?></div>
                                                <div style="font-size:0.72rem;color:var(--text-muted)">
                                                    <?= htmlspecialchars($o['title']) ?></div>
                                            </td>
                                            <td style="text-align:right">
                                                <div style="font-weight:700;font-size:0.83rem">
                                                    <?= formatRupiah($o['total_amount']) ?></div>
                                                <span
                                                    class="badge <?= $o['payment_status'] === 'paid' ? 'badge-green' : ($o['payment_status'] === 'pending' ? 'badge-yellow' : 'badge-red') ?>"><?= $o['payment_status'] === 'paid' ? 'Lunas' : ($o['payment_status'] === 'pending' ? 'Pending' : 'Gagal') ?></span>
                                            </td>
                                        </tr>
                    ...
                    <div class="card">
                        ...
                        <div style="padding:4px 0">
                            <?php if (empty($topFilms)): ?>
                                <div style="text-align:center;color:var(--text-muted);padding:24px;font-size:0.875rem">Belum
                                    ada data</div>
                            <?php else:
                                $rank = 1;
                                ...
                                foreach ($topFilms as $tf): ?>
                                    <div
                                        ...
                                        <div
                                            style="width:28px;height:28px;border-radius:8px;display:flex;align-items:center;justify-content:center;font-weight:700;font-size:0.8rem;background:<?= $clrs[$rank - 1] ?>22;color:<?= $clrs[$rank - 1] ?>;flex-shrink:0">
                                            <?= $rank ?></div>
                                        <div style="flex:1;min-width:0">
                                            <div
                                                style="font-size:0.83rem;font-weight:600;white-space:nowrap;overflow:hidden;text-overflow:ellipsis">
                                                <?= htmlspecialchars($tf['title']) ?></div>
                                            <div style="font-size:0.72rem;color:var(--text-muted)"><?= $tf['tickets'] ?> tiket
                                            </div>
                                        </div>
                                        <span
                                            style="font-size:0.82rem;font-weight:700;color:var(--red);flex-shrink:0"><?= formatRupiah($tf['revenue']) ?></span>
                                    </div>
                ...
                <div class="card">
                    ...
                    <div
                        style="display:grid;grid-template-columns:repeat(auto-fill,minmax(120px,1fr));gap:10px;padding:16px">
                        ...
                        foreach ($qa as [$href, $lbl, $clr, $d]): ?>
                            <a href="<?= $href ?>"
                                style="background:var(--bg-card2);border:1.5px solid var(--border);border-radius:12px;padding:14px 10px;text-align:center;display:block;color:var(--text);"
                                onmouseover="this.style.borderColor='<?= $clr ?>'"
                                onmouseout="this.style.borderColor='var(--border)'">
                                <div
                                    style="width:36px;height:36px;border-radius:10px;background:<?= $clr ?>22;margin:0 auto 8px;display:flex;align-items:center;justify-content:center">
                                    <svg width="18" height="18" fill="none" stroke="<?= $clr ?>" stroke-width="2"
                                        viewBox="0 0 24 24">
                                        <path d="<?= $d ?>" />
                                    </svg>
                                </div>
